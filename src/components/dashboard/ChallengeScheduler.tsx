  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {isLoading && <p className="font-cute text-[#a8889a]">불러오는 중...</p>}
        {!isLoading && challenges.length === 0 && (
          <p className="font-cute text-[#cdb8c4]">등록된 챌린지가 없어요.</p>
        )}
        {challenges.map((challenge) => (
          <div
            key={challenge.id}
            className="rounded-3xl border-2 border-white/70 bg-white/80 p-5 shadow-md backdrop-blur"
          >
